...
image: featured.jpg
alias:
  - /teaching/2021-05-04-data-viz-accessibility/
categories:
  - journalism
  - R
  - education
...
# location: Virtual
subtitle: "Data visualization accessibility teaching to share what we found after scraping alternative (alt) text from data viz shared on Twitter as part of the #TidyTuesday social project."
